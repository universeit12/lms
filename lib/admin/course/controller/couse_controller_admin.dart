...
import '../../../app/business logic/model/all_course_model.dart';

class CouseControllerAdmin extends GetxController {
  ...
  void fetchCourseData() async {
    try {
      ...
      final response = await http.get(Uri.parse(
          "https://lms-server-theta.vercel.app/api/v1//admin-all-course"));
